...
var Pie = function(filling) {
  Pie.__init__(this, filling);
  this.__class__ = Pie;
  this.__uid__ = ("￼" + _PythonJS_UID);
  _PythonJS_UID += 1;
}

Pie.__uid__ = ("￼" + _PythonJS_UID);
_PythonJS_UID += 1;
Pie.prototype.__init__ = function(filling) {
  
  this.fill_with(filling);
  this.eaten = false;
}

Pie.__init__ = function () { return Pie.prototype.__init__.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
Pie.prototype.eat = function() {
  
  this.eaten = true;
}

Pie.eat = function () { return Pie.prototype.eat.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
Pie.prototype.fill_with = function(filling) {
  
  this.filling = filling;
}

Pie.fill_with = function () { return Pie.prototype.fill_with.apply(arguments[0], Array.prototype.slice.call(arguments,1)) };
Pie.prototype.__properties__ = {  };
Pie.prototype.__unbound_methods__ = {  };
apple_pie =  new Pie("apple");
apple_pie.eat;
var __comp__0;
var idx0;
var iter0;
...
frame = "".join(__comp__0);
console.log(frame);
console.log(__sprintf("* Who ate the %s pie?!? *", apple_pie.filling));
console.log(frame);
